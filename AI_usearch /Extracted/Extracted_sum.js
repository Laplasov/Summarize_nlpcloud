...
fs.readFile('usearch_14.json', 'utf8', (err, data) => {
  if (err) throw err;
  ...
  const makeRequest = () => {
    client.summarization(jsonData[i].body)
      .then(function (response) {
        ...
        fs.appendFile(`responses/response_14.json`, JSON.stringify(responseData) + ',\n', (err) => {
          if (err) throw err;
          console.log(`Response saved to file 14.json`);
          i++;
